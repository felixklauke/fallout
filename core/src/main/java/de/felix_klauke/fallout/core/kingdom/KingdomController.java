...
public interface KingdomController {
    ...
    void createKingdom(UUID uniqueId, UUID ownerUniqueId, String name, double balance, String description, String worldName, int x, int z, Consumer<Boolean> resultConsumer);
